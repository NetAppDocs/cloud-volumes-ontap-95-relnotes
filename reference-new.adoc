...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws-c2s.html[Get started in the AWS C2S environment^]
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-encrypting-volumes.html[Learn how to set up NetApp Volume Encryption^]
...
Data-at-rest encryption of aggregates using external key managers is no longer supported. If you are currently using this feature and you want to upgrade, you must launch a new 9.5 system and then https://docs.netapp.com/us-en/cloud-manager-replication/task-replicating-data.html[replicate data] to that system.

Data-at-rest encryption is still supported using other methods. You can encrypt data by using NetApp Volume Encryption or by using the AWS Key Management Service (KMS). https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-security.html[Learn more about encryption of data at rest^].

==== c4.2xlarge is no longer supported

The c4.2xlarge instance type is not supported with the 9.5 release. If you are currently using this instance type, you must first https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-modifying-ontap-cloud.html[change to a new instance type] before you upgrade to the 9.5 release.
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-azure.html[Learn more about HA pairs in Azure^].
