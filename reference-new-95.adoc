---
sidebar: sidebar
permalink: reference-new-95.html
...
For information about disk limits, refer to link:reference-storage-limits-95.html[storage limits].
...
These instances use a hypervisor that is based on KVM technology. As a result, the instances support a smaller number of data disks than other instance types: up to 24 data disks for single-node systems and 21 data disks for HA pairs. link:reference-storage-limits-95.html[Learn about storage limits].
